                ...
                <div className="flex items-center space-x-2 md:space-x-4">
                    ...
                    <button className="flex items-center space-x-3 p-1.5 hover:bg-earth-50 rounded-2xl transition-all">
                        ...
                        <div className="hidden lg:block text-left">
                            <p className="text-xs font-black text-earth-900 leading-none uppercase">{user.name}</p>
                            <p className="text-[10px] font-bold text-earth-400 mt-1 uppercase tracking-widest">Administrateur</p>
                        </div>
                    </button>
                </div>
            </div>
